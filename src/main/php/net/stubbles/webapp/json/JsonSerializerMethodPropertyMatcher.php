...
/**
 * Matcher for methods and properties that should be respected for JSON serialization.
 *
 * @since  3.2.0
 */
class JsonSerializerMethodPropertyMatcher implements MethodMatcher, PropertyMatcher
{
    /**
    ...
    {
        return ($method->hasAnnotation('JsonIgnore') !== true);
    }
    ...
    {
        return ($property->hasAnnotation('JsonIgnore') !== true);
    }
}
?>